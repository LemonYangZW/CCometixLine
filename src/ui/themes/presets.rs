    ...
    pub fn get_powerline_dark() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_dark::sub2api_segment(),
    ...
    pub fn get_powerline_light() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_light::sub2api_segment(),
    ...
    pub fn get_powerline_rose_pine() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_rose_pine::sub2api_segment(),
    ...
    pub fn get_powerline_tokyo_night() -> Config {
        Config {
            ...
            segments: vec![
                ...
                theme_powerline_tokyo_night::sub2api_segment(),
